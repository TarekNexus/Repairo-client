        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div className="flex flex-col">
            ...
            <input
              ...
              className={`border px-4 py-2 font-satoshi rounded-lg text-black placeholder-gray-500 focus:outline-none focus:ring-2 focus:border-[#5ce1e6] ${errors.name ? "border-red-500 focus:ring-red-500" : "border-gray-300 focus:ring-[#5ce1e6]"}`}
            />
            {errors.name && (
          ...
          <div className="flex flex-col">
            ...
            <input
              ...
              className={`border px-4 py-2 font-satoshi rounded-lg text-black placeholder-gray-500 focus:outline-none focus:ring-2 focus:border-[#5ce1e6] ${errors.email ? "border-red-500 focus:ring-red-500" : "border-gray-300 focus:ring-[#5ce1e6]"}`}
            />
            {errors.email && (
              <span className="text-red-500 text-sm">
          ...
          <div className="flex flex-col">
            ...
            <input
              ...
              className={`border px-4 py-2 font-satoshi text-black rounded-lg placeholder-gray-500 focus:outline-none focus:ring-2 focus:border-[#5ce1e6] ${errors.password ? "border-red-500 focus:ring-red-500" : "border-gray-300 focus:ring-[#5ce1e6]"}`}
            />
            {errors.password && (
              <span className="text-red-500 text-sm">
          ...
          <div className="flex flex-col">
            ...
            <input
              ...
              className="border border-gray-300 text-black rounded-lg font-satoshi px-4 py-2 focus:outline-none focus:ring-2 focus:ring-[#5ce1e6] focus:border-[#5ce1e6]"
            />
            {uploading && (
