...
const Hero = () => {
  return (
    <section
      className="relative rounded-none lg:mb-14 mb-6 mx-auto rounded-b-[40px] h-120.75 flex items-center justify-center overflow-hidden"
      style={{
        backgroundImage: `url('/imgs/ElectricianService.jpeg')`,
    ...
    >
      ...
      >
        ...
        >
          Expert Repairs, Right at Your Door
        </motion.h1>
